      ...
      <div className="flex content-center">
        ...
        <div className="flex-2 w-5/12 mx-auto">
          <ul className="flex mt-4 items-around">
            <li
              onClick={() => navigate("/")}
              className="text-lg cursor-pointer font-semibold text-[black] hover:opacity-90 lg:ml-7 ml-6 mr-1.5"
            >
              Home
            </li>
            <li
              className="text-lg cursor-pointer font-semibold text-[black] hover:opacity-90 ml-6 mr-1.5"
        ...
        {!Cookies.get("refresh-token") ? (
          <div className="flex items-center">
            <button
              ...
              className="hover:bg-[#219653] bg-white border-2 transition border-[black] text-[#black] hover:text-white font-bold py-1 px-8 rounded mx-2"
            >
              Login
            </button>
            <button
              onClick={() => setShowRegister(true)}
              className="hover:bg-[#219653] bg-white border-2 transition border-[black] text-[black] hover:text-white font-bold py-1 px-8 rounded mx-4"
            >
              Sign Up
            </button>
          </div>
