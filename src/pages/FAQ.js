              ...
              <div class="w-full lg:w-1/2 px-4 py-2">
                <details class="mb-4">
                  <summary class="font-semibold text-lg bg-gray-200 rounded-md py-2 px-4">
                    How do I sell my Farm Products ?
                  </summary>

                  <span className="text-justify">
                    You can sell your Farm Products by listing it on AgriConnect website.
                  </span>
                </details>
                <details class="mb-4">
                  ...
                  <span className="text-justify">
                    Listing on AgriConnect is very easy. Just click on the
                    button LIST YOUR EQUIPMENT on the middle of the home page or
                    website. Choose product type and details and click “List
                ...
                <details class="mb-4">
                  ...
                  <span className="text-justify">
                    You can sell your new or used machinery by listing it on
                    AgriConnect website or mobile applications. Don’t forget
              ...
              <div class="w-full lg:w-1/2 px-4 py-2">
                <details class="mb-4">
                  ...
                  <span class="px-4 py-2 text-justify">
                    ...
                    providers are open to selling equipment on AgriConnect
                    with a fair deal.
                  </span>
                </details>
                <details class="mb-4">
                  <summary class="font-semibold  bg-gray-200 rounded-md py-2 px-4">
                    I don't have a website, Can I still sell on AgriConnect?
                  </summary>

                  <span class="px-4 py-2 text-justify">
                    You don't need a website to start selling on AgriConnect.
